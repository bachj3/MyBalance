...
var E_Description = ["Setzen Sie Ihren gesunden Fuss auf den Fussr&uuml;cken Ihres verletzen Fusses und erzeugen Sie dabei eine entsprechende Spannung auf den Vorfuss.", "Ein doppeltes Deuserband kommt &uuml;ber beide Fussr&uuml;cken. Bewegen Sie Ihr verletztes Bein maximal nach aussen, so dass das Deuserband maximal gespannt wird. Dann wird nur die Ferse auf den Boden gestellt.", "Ellbogen 90&deg; gebeugt, nach aussen gedrehter Arm. In dieser Position liegt der Handr&uuml;cken auf der Waage. Mit der Hand kr&auml;ftig das Gewicht auf die Waage dr&uuml;cken. Die Spannung halten und die &Uuml;bung wiederholen.", "Kneten Sie den Therapieball.", "Schwimmen bietet eine ideale Kombination von Ausdauer, Muskelaufbau und Fettverbrennung.", "Lesen Sie doch wieder einmal ein Buch", "-"];
var S = ["2", "3", "2", "3", "-", "-", "-"];
var R = ["12", "8", "4", "20", "-", "-", "-"];
var W = ["-", "-", "1.5", "-", "-", "-", "-"];
